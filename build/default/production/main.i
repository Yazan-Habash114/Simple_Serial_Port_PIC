...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\float.h" 1 3
...
# 46 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\float.h" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\bits/float.h" 1 3
# 46 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\float.h" 2 3
# 61 "main.c" 2
...
UByte port_d __attribute__((address(0xF83)));
...
lcdType lcd __attribute__((address(0xF83)));
lcdType lcd_tris __attribute__((address(0x95)));
...
void print_structure(SType* v, int n)
{
...
void print_union(UType* u, int n )
{
   unsigned short ls, hs;
   ls = u->lng & 0x0000FFFF;
   hs = (u->lng) >> 16;
...
int main(void)
{
    ...
    extern volatile char gotten __attribute__((address(0x020)));
    gotten = 'a';
    char * ptr = &gotten;
